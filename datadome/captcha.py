...
if __name__ == "__main__":
    ...
    # 1. Try to load the login url of Zocdoc using Incognito headers, to get targeted by the captcha
    url = "https://www.zocdoc.com/signin"
    ...
    # 2. Try to build the challenge url
